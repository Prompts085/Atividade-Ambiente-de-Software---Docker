...
Demonstrar a criação, configuração e execução de um ambiente simples em Docker, contendo:
- Um container com **Flask (Python)**.
- Um container com **MySQL**.
- Comunicação entre os dois via **rede local (bridge)** do Docker.
